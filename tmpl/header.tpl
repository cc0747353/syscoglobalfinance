                            ...
                            <div class="container">
                                ...
                                <div class="mobile-header-content d-lg-flex flex-wrap justify-content-lg-between align-items-center">
                                    <ul class="support-area">
                                        ...
                                        <li>
                                            <a href="Mailto:support@syscoglobalfinance.net"><i class="flaticon-email"></i><span class="__cf_email__" data-cfemail="620b0c040d220a1b0b120e030c064c010d0f">support@syscoglobalfinance.net</span> </a>
                                        </li>
